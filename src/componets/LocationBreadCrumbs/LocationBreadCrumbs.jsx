                            ...
                            <Dropdown>
                                ...
                                <DropdownMenu aria-label="Routes">
                                    <DropdownItem key="info"
                                                  onClick={() => handleNavigate(routes.admin.locationAdminInfo.url)}
                                                  isDisabled={location.pathname === routes.admin.locationAdminInfo.url}>
                                        {routes.admin.routeAdminInfo.name}
                                    </DropdownItem>
                                    <DropdownItem key="media"
                                                  onClick={() => handleNavigate(routes.admin.locationAdminMedia.url)}
                                                  isDisabled={location.pathname === routes.admin.locationAdminMedia.url}>
